...
public static class MathB
{
    ...
    /// <returns></returns>
    public static List<GameObject> ShapesOfGameObjects(GameObject pf, float radius, int amount, Shapes shape, Vector3 disp)
    {
        ...
        if (shape == Shapes.Wall)
        {
            for (int i = 0; i < amount; i++)
            {
                ...
                //Instantiate
                GameObject obj = Object.Instantiate(pf, pos + disp, Quaternion.identity) as GameObject;
                objects.Add(obj);
            }
        }
        else
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                GameObject obj = Object.Instantiate(pf, position + disp, rot) as GameObject;
